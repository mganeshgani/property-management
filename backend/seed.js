  ...
  try {
    ...
    const propertiesData = [
      ...
      },
      {
        ...
        slug: 'modern-1bhk-near-manyata-tech-park',
        description: 'Compact and modern 1BHK apartment ideal for IT professionals. Includes modular kitchen, excellent ventilation, and easy access to Manyata Tech Park.',
        propertyType: 'flat',
        listingType: 'rent',
        price: 18000,
        priceUnit: 'per_month',
        ...
        location: { address: '9 Nagavara Main Road', city: 'Bangalore', state: 'Karnataka', pincode: '560045', country: 'India' },
        images: [{ url: 'https://images.unsplash.com/photo-1494526585095-c41746248156?w=800', publicId: 'seed_prop_9' }],
        owner: owner2._id,
        status: 'available',
        isActive: true,
        isFeatured: false,
      ...
      },
      {
        ...
        slug: 'premium-penthouse-in-indiranagar',
        description: 'Luxury penthouse with private terrace, skyline views, and premium interiors in a prime Indiranagar neighborhood.',
        propertyType: 'flat',
        listingType: 'sale',
        price: 22000000,
        priceUnit: 'total',
        ...
        floors: 1,
        furnishing: 'furnished',
        amenities: ['Terrace', 'Lift', 'Security', 'CCTV', 'Power Backup', 'Parking'],
        location: { address: '101 12th Main, Indiranagar', city: 'Bangalore', state: 'Karnataka', pincode: '560038', country: 'India' },
        images: [{ url: 'https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?w=800', publicId: 'seed_prop_10' }],
        owner: owner1._id,
        status: 'available',
        isActive: true,
        isFeatured: true,
      ...
      {
        title: 'Warehouse Space in Peenya Industrial Area',
        slug: 'warehouse-space-in-peenya-industrial-area',
        description: 'Large commercial warehouse with loading dock access and 24/7 security in Peenya Industrial Area.',
        propertyType: 'commercial',
        listingType: 'lease',
        price: 200000,
        priceUnit: 'per_month',
        ...
        floors: 1,
        furnishing: 'unfurnished',
        amenities: ['Parking', 'Security', 'CCTV', 'Power Backup', 'Fire Safety'],
        location: { address: 'Plot 77, Peenya Phase 2', city: 'Bangalore', state: 'Karnataka', pincode: '560058', country: 'India' },
        images: [{ url: 'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=800', publicId: 'seed_prop_11' }],
        owner: owner2._id,
        status: 'available',
        isActive: true,
        isFeatured: false,
      ...
      {
        title: 'Ready-to-Move 3BHK House in Yelahanka',
        slug: 'ready-to-move-3bhk-house-in-yelahanka',
        description: 'Family-friendly independent house with car parking and terrace in a calm Yelahanka residential locality.',
        propertyType: 'house',
        listingType: 'sale',
        price: 9800000,
        priceUnit: 'total',
        ...
        floors: 2,
        furnishing: 'semi',
        amenities: ['Parking', 'Water Supply', 'Power Backup', 'Garden'],
        location: { address: '44 New Town, Yelahanka', city: 'Bangalore', state: 'Karnataka', pincode: '560064', country: 'India' },
        images: [{ url: 'https://images.unsplash.com/photo-1570129477492-45c003edd2be?w=800', publicId: 'seed_prop_12' }],
        owner: owner1._id,
        status: 'available',
        isActive: true,
        isFeatured: false,
